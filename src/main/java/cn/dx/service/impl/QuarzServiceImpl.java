...
public class QuarzServiceImpl implements QuartzService {
        ...
        try {
            ...
            if (trigger != null) {
                ...
                if (trigger instanceof CronTrigger) {
                    ...
                    map.put("jobTime", QuartzCronDateUtil.getFormatDate(cronExpression));
                }
            }
        } catch (SchedulerException e) {
            e.printStackTrace();
    ...
    /**
     * 按照组别查询订阅消息
     * @param jobGroupName 组别名字
     * @return 组别列表
     */
    @Override
    public List<Map<String, Object>> queryJobByGroup(String jobGroupName) {
        List<Map<String, Object>> jobList = null;
        try {
